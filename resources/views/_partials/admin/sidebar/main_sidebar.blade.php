...
@if (!Request::is('admin/report*'))
    ...
    @can('sale_pos.view')
        <li class="treeview {{ Request::is('admin/sale*') ? ' is-expanded' : '' }}">
            <a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-minus-circle"
                                                                         aria-hidden="true"></i>
                <span class="app-menu__label">{{_lang('Sale Pos')}}</span><i
    ...
    @can('employee.view')
        ...
        <li data-placement="bottom" title="Employee all System"
            ...
            <a class="app-menu__item" href="#" data-toggle="treeview"><i
                    class="app-menu__icon fa fa-user-circle"></i><span class="app-menu__label">{{_lang('HRM')}}</span><i
                    class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                ...
                @can('employee_list.view')
                    ...
                    <li class="mt-1"><a class="treeview-item {{Request::is('admin/employee-list*') ? 'active':''}}"
                                        href="{{ route('admin.employee-list.index') }}"><i
                                class="icon fa fa-circle-o"></i>
                            {{_lang('Employee')}}</a></li>
                @endcan
                    ...
                    @can('employee_attendance.view')
                        <li class="mt-1"><a
                                class="treeview-item {{Request::is('admin/attendance-employee-attendance*') ? 'active':''}}"
                                href="{{ route('admin.attendance-employee-attendance.index') }}"><i
                                    class="icon fa fa-circle-o"></i> {{_lang('Employee Attendance')}}</a></li>
                    @endcan
                ...
                @endcan
                    ...
                    @can('employee_payroll.view')
                        <li class="mt-1"><a
                                class="treeview-item {{ Request::is('admin/payroll*') ? ' active' : '' }}"
                                href="{{ route('admin.payroll.view') }}"><i
                                    class="icon fa fa-circle-o"></i>{{_lang('Payroll')}}</a></li>
                    @endcan
                ...
                @can('employee_shift.view')
                    <li class="mt-1"><a class="treeview-item {{Request::is('admin/employee-shift*') ? 'active':''}}"
                                        href="{{ route('admin.employee-shift.index') }}"><i
                                class="icon fa fa-circle-o"></i> {{_lang('Employee Shift')}}</a></li>
                @endcan

                    {{-- holiday --}}
                    @can('holiday.view')
                        <li class="mt-1"><a
                                class="treeview-item {{ Request::is('admin/holiday*') ? ' active' : '' }}"
                                href="{{ route('admin.holiday.index') }}"><i
                                    class="icon fa fa-circle-o"></i> {{_lang('Holiday')}}</a></li>
                    @endcan
                ...
                @can('employee_category.view')
                    ...
                    <li class="mt-1"><a class="treeview-item {{Request::is('admin/employee-category*') ? 'active':''}}"
                                ...
                                class="icon fa fa-circle-o"></i> {{_lang('Employee Category')}}</a></li>
                @endcan
                ...
                @can('employee_leave_type.view')
                    ...
                    <li class="mt-1"><a class="treeview-item {{Request::is('admin/emp-leave*') ? 'active':''}}"
                                        href="{{ route('admin.employee-leave-type.index') }}"><i
                                class="icon fa fa-circle-o"></i>
                ...
                @endcan
                    ...
                    @can('employee_attendance_type.view')
                        <li class="mt-1"><a
                                class="treeview-item {{Request::is('admin/attendance-attendance-type*') ? 'active':''}}"
                                href="{{ route('admin.attendance-attendance-type.index') }}"><i
                                    class="icon fa fa-circle-o"></i> {{_lang('Attendance Type')}}</a></li>
                    @endcan
    ...
    @can('production.view')
        {{-- User Section--}}
        <li class="treeview {{ Request::is('admin/production*') ? ' is-expanded' : '' }}"><a class="app-menu__item"
                                                                                             href="#"
                                                                                             data-toggle="treeview"><i
                    class="app-menu__icon fa fa-stumbleupon"></i><span
    ...
    @can('production_product.view')
        <li data-placement="bottom" title="Department"><a
                ...
                href="{{ route('admin.product_list') }}"><i class="app-menu__icon fa fa-calendar"
    ...
    @can('job_work.view')
        <li data-placement="bottom" title="Job Work"><a
                ...
                href="{{ route('admin.job_work.index') }}"><i class="app-menu__icon fa fa-ils"
                                                              aria-hidden="true"></i><span
    ...
    @can('Ecommerce.view')
        ...
        <li class="treeview {{ Request::is('admin/eCommerce*') ? ' is-expanded' : '' }}"><a class="app-menu__item"
            ...
            <ul class="treeview-menu">
                ...
                <li class="mt-1"><a
                        class="treeview-item {{Request::is('admin/eCommerce/feature-product*') ? 'active':''}}"
                ...
                <li class="mt-1"><a
                        class="treeview-item {{Request::is('admin/eCommerce/hotsale-product*') ? 'active':''}}"
                ...
                {{--Product Rating --}}
                <li class="mt-1"><a
                        class="treeview-item {{Request::is('admin/eCommerce/product-rating*') ? 'active':''}}"
                        href="{{ route('admin.eCommerce.product-rating.index') }}"><i
                            class="icon fa fa-circle-o"></i>{{_lang('Product Rating')}}</a></li>

                {{--Term and Condition --}}
                <li class="mt-1"><a
                        class="treeview-item {{Request::is('admin/eCommerce/terams-conditions/index*') ? 'active':''}}"
                ...
                <li  class="mt-1"><a target="_blank" class="treeview-item"
                       href="https://fontawesome.com/v4.7.0/icons/"><i
...
@can('setting.view')
    ...
    <li class="treeview {{ Request::is('admin/setting*') ? ' is-expanded' : '' }}"><a class="app-menu__item" href="#"
                                                                                      data-toggle="treeview"><i
                class="app-menu__icon fa fa-cogs"></i><span class="app-menu__label">{{_lang('Settings')}}</span><i
                class="treeview-indicator fa fa-angle-right"></i></a>
        <ul class="treeview-menu">
            @can('setting.view')
                {{-- General Settings --}}
