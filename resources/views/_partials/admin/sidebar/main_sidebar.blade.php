        ...
        <li class="treeview {{ Request::is('admin/production*') ? ' is-expanded' : '' }}"><a class="app-menu__item" href="#"
                ...
                <ul class="treeview-menu">
                        @can('production_category.view')
                                {{-- Category --}}
                                <li class="mt-1"><a class="treeview-item {{Request::is('admin/production-category*') ? 'active':''}}" href="{{ route('admin.production-category.index') }}"><i class="icon fa fa-circle-o"></i> {{_lang('Category')}}</a></li>
                        @endcan
                        @can('production_brands.view')
                                {{-- Brands --}}
                                <li class="mt-1"><a class="treeview-item {{Request::is('admin/production-brands*') ? 'active':''}}" href="{{ route('admin.production-brands.index') }}"><i class="icon fa fa-circle-o"></i> {{_lang('Brand')}}</a></li>
                        @endcan
                        @can('production_variation.view')
                                {{-- Variation Template --}}
                                <li class="mt-1"><a class="treeview-item {{Request::is('admin/production-variation*') ? 'active':''}}" href="{{ route('admin.production-variation.index') }}"><i class="icon fa fa-circle-o"></i> {{_lang('Variation')}}</a></li>
                        @endcan
                        @can('production_ingredients.view')
                                {{-- Ingredients Categor --}}
                                <li class="mt-1"><a class="treeview-item {{Request::is('admin/production-ingredients-category*') ? 'active':''}}" href="{{ route('admin.production-ingredients-category.index') }}"><i class="icon fa fa-circle-o"></i> {{_lang('Ingredients Category')}}</a></li>
                        @endcan
                        @can('production_product.view')
                                {{-- Production Product --}}
                                <li class="mt-1"><a class="treeview-item {{Request::is('admin/production-product*') ? 'active':''}}" href="{{ route('admin.production-product.index') }}"><i class="icon fa fa-circle-o"></i> {{_lang('Production Product')}}</a></li>
                        @endcan

                        @can('unit.view')
                                {{-- Production Unit --}}
                                <li class="mt-1"><a class="treeview-item {{Request::is('admin/production-unit*') ? 'active':''}}" href="{{ route('admin.production-unit.index') }}"><i class="icon fa fa-circle-o"></i> {{_lang('Unit')}}</a></li>
                        @endcan
                        @can('production-raw-materials.view')
                                {{-- Production Raw Materials --}}
                                <li class="mt-1"><a class="treeview-item {{Request::is('admin/production-raw-materials*') ? 'active':''}}" href="{{ route('admin.production-raw-materials.index') }}"><i class="icon fa fa-circle-o"></i> {{_lang('Raw Materials')}}</a></li>
                        @endcan
                         @can('production-raw-materials.view')
                                {{-- Production Work Order --}}
                                <li class="mt-1"><a class="treeview-item {{Request::is('admin/production-work-order*') ? 'active':''}}" href="{{ route('admin.production-work-order.index') }}"><i class="icon fa fa-circle-o"></i> {{_lang('Work Order')}}</a></li>
                        @endcan
                        @can('production_wop_materials.view')
                                {{-- Production wop Materials --}}
                                <li class="mt-1"><a class="treeview-item {{Request::is('admin/production-wop-materials*') ? 'active':''}}" href="{{ route('admin.production-wop-materials.index') }}"><i class="icon fa fa-circle-o"></i> {{_lang('WOP Materials')}}</a></li>
                        @endcan

                        @can('production_purchase.view')
                                {{-- Production Purchase --}}
                                <li class="mt-1"><a class="treeview-item {{Request::is('admin/production-purchase*') ? 'active':''}}" href="{{ route('admin.production-purchase.index') }}"><i class="icon fa fa-circle-o"></i> {{_lang('Purchase List')}}</a></li>
                        @endcan
                </ul>
        </li>
        @endcan
        ...
        <li class="treeview {{ Request::is('admin/request*') ? ' is-expanded' : '' }}">
            ...
            <ul class="treeview-menu">
                ...
                {{-- Expense Category--}}
                <li class="mt-1">
                    <a class="treeview-item {{Request::is('admin/request') ? 'active':''}}" href="{{ route('admin.request.index') }}">
                ...
                {{-- Expense --}}
                <li class="mt-1">
                    <a class="treeview-item {{Request::is('admin/request/create') ? 'active':''}}" href="{{ route('admin.request.create') }}">
                        <i class="icon fa fa-circle-o"></i>
    ...
    @can('marketing.view')
        {{-- User Section--}}
        <li class="treeview {{ Request::is('admin/emailmarketing*') ? ' is-expanded' : '' }}"><a class="app-menu__item" href="#"
                data-toggle="treeview"><i class="app-menu__icon fa fa-envelope"></i><span
            ...
            <ul class="treeview-menu">
                ...
                <li class="mt-1"><a
                        ...
                        href="{{ route('admin.emailmarketing.media.index') }}"><i class="icon fa fa-circle-o"></i>{{_lang('Media')}}</a>
                </li>
                @endcan
       ...
       @can('expense.view')
        ...
        <li class="treeview {{ Request::is('admin/smsmerketing*') ? ' is-expanded' : '' }}">
            <a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-commenting" aria-hidden="true"></i>
                <span class="app-menu__label">{{_lang('SMS Marketing')}}</span><i class="treeview-indicator fa fa-angle-right"></i>
            </a>
            <ul class="treeview-menu">
                @can('expenseCategory.view')
                {{-- Expense Category--}}
                <li class="mt-1">
                    <a class="treeview-item {{Request::is('admin/smsmerketing/sendsms*') ? 'active':''}}" href="{{ route('admin.smsmerketing.sendsms.create') }}">
                        <i class="icon fa fa-circle-o"></i>
                        {{_lang('Send Sms')}}
                    </a>
                </li>
                ...
                {{-- Expense --}}
                <li class="mt-1">
                    <a class="treeview-item {{Request::is('admin/smsmerketing/sms-history') ? 'active':''}}" href="{{ route('admin.smsmerketing.sms_history') }}">
                        <i class="icon fa fa-circle-o"></i>
                        {{_lang('Sms History')}}
                    </a>
                </li>
       ...
       @can('expense.view')
        ...
        <li class="treeview {{ Request::is('admin/expense*') ? ' is-expanded' : '' }}">
            <a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-minus-circle" aria-hidden="true"></i>
                <span class="app-menu__label">{{_lang('Expense')}}</span><i class="treeview-indicator fa fa-angle-right"></i>
            </a>
            <ul class="treeview-menu">
                @can('expenseCategory.view')
                {{-- Expense Category--}}
                <li class="mt-1">
                    <a class="treeview-item {{Request::is('admin/expense/category') ? 'active':''}}" href="{{ route('admin.expense.category.index') }}">
                        <i class="icon fa fa-circle-o"></i>
