...
@section('page.header')
    <div class="app-title">
        <div>
            <h1 data-placement="bottom" title="Employee Attendance Type."><i class="fa fa-universal-access mr-4"></i> {{_lang('Employee Attendance Type')}}</h1>
            <p>{{_lang('Create Employee Attendance Type. Here you can Add, Edit & Delete The Employee Attendance Type')}}</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
            {{ Breadcrumbs::render('employee-attendance-type') }}
        </ul>
    </div>
@stop
