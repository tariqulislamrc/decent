            ...
            <div class="col-md-6 table-responsive">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    @php
                        ...
                        $items = App\models\employee\EmployeeSalaryDetail::where('employee_salary_id', $salary->employee_id)->get();
            ...
            <div class="col-md-6 table-responsive">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <th with="50%" class="text-center">{{get_option('currency') && get_option('currency') != '' ? get_option('currency') : 'BDT' }} {{find_employee_earning_salary_using_employee_id($salary->employee_id)}}</th>
            ...
            <div class="col-md-6 table-responsive">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <th with="50%" class="text-center">{{get_option('currency') && get_option('currency') != '' ? get_option('currency') : 'BDT' }} {{find_employee_deduction_salary_using_employee_id($salary->employee_id)}}</th>
        ...
        <div class="col-md-12 table-responsive">
            ...
            <table class="table table-bordered table-stringped">
                ...
                <tr>
                    ...
                    <th with="50%" class="text-center">{{get_option('currency') && get_option('currency') != '' ? get_option('currency') : 'BDT' }} {{find_employee_total_salary_using_employee_id($salary->employee_id)}}</th>
