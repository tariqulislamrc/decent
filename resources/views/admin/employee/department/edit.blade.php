<div class="card">
    ...
    <div class="card-body">
        <form action="{{route('admin.employee.department.update', $model->id)}}" method="post" id="content_form">
            @csrf
            <div class="row">
                ...
                <div class="col-md-12 form-group">
                    ...
                    <textarea name="description" class="form-control" id=""
                        placeholder="Enter Employee Department Description">{{$model->description}}</textarea>
