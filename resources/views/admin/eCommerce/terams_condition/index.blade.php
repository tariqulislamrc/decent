@extends('layouts.app', ['title' => _lang('Terms Conditions'),'modal' => 'lg'])
@push('admin.css')
...
<div class="app-title">
  <div>
    ...
    {{_lang('Terms &  Conditions')}}</h1>
    <p>{{_lang('Terms and Condition of your company')}}</p>
  </div>
</div>
@stop
{{-- Main Section --}}
...
<div class="card">
  <div class="card-header">
    <h6>{{ isset($model) ? _lang('Update'):_lang('Create') }} {{_lang('Terms & Conditions')}}</h6>
  </div>
  <div class="card-body">
    <form action="{{route('admin.eCommerce.terams-conditions.store')}}" id='content_form' class ='form-validate-jquery' method="post" >
