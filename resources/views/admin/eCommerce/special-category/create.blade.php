<div class="col-md-6 mx-auto text-center mb-3 border bg-light border-info">
    <b>Create New Special Category</b>
</div>

<form action="{{ route('admin.eCommerce.special-category.store') }}" id="content_form" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="col-md-12 form-group">
        ...
        <input type="file" name="cover_image" id="cover_image" class="form-control dropify" required>
