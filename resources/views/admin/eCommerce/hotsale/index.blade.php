@extends('layouts.app', ['title' => _lang('Hot Sale Product'), 'modal' => 'xl'])

{{-- Header Section --}}
@section('page.header')
    <div class="app-title">
        <div>
            <h1 data-placement="bottom" title="Product Coupons"><i class="fa fa-universal-access mr-4"></i> {{_lang('Hot Sale Product')}}</h1>
            <p>{{_lang('Here You Can see all of your Hot Sale product list. you can add or remove product from your Hot Sale product list')}}</p>
        </div>
