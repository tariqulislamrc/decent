...
<div class="app-title">
    ...
    <ul class="app-breadcrumb breadcrumb">
        {{Breadcrumbs::render('home-page-create') }}
    </ul>
</div>
@stop
...
<form action="{{route('admin.eCommerce.home-page.store')}}" method="post" id="content_form" enctype="multipart/form-data">
    @csrf
    <div class="card">
        <div class="card-header">
            <h6>{{_lang('Add New Home page Image')}}</h6>
        </div>
        <div class="card-body">
            <div class="row">
                {{-- Product_id --}}
