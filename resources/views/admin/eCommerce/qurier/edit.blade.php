<div class="card">
    <div class="card-header">
        <h6 class="text-center"> Edit Qurier Option - <span class="badge badge-primary">{{$model->name}} </span> </h6>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.eCommerce.qurier.update',$model->id) }}" method="POST" id="content_form">
            @method('PATCH')
            <div class="row">
                {{-- Name --}}
