    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <!--<a href="" target="blank">-->
                    <button data-url="{{route('admin.eCommerce.order.pdf',$model->reference_no)}}" type="button" class="btn btn-primary btn_modal btn-block text-center">{{_lang('Print Invoice')}}</button>
                    <!--</a>-->
            </div>
        </div>
    </div>
