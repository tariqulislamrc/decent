@extends('layouts.app', ['title' => _lang('Sales Report'), 'modal' => 'lg'])
{{-- Header Section --}}
@section('page.header')
<div class="app-title">
	<div>
	...
	<div class="card-body">
        ...
        <div class="col-md-4 form-group">
          ...
          <select name="sale_type" id="sale_type" class="form-control select">
              ...
              <button data-url="{{route('admin.report.selling.get_sales_report')}}" type="button" id="submit" class="btn btn-block btn-sm btn-info">{{ _lang('Get  Report') }}</button>
