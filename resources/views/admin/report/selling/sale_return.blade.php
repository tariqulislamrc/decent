	...
	<div class="card-body">
			<div class="row">
				...
				<div class="col-md-6 mx-auto">
	              <button data-url="{{route('admin.report.selling.sale_return_report')}}" type="button" id="submit" class="btn btn-block btn-sm btn-info">{{ _lang('Get  Report') }}</button>
...
$(function() {
    ...
    get_data(client_id,transaction_id,user_id, sDate, eDate);
});
...
function get_data(client_id,transaction_id,user_id, sDate, eDate) {
