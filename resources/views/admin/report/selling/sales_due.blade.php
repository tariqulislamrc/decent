...
<div class="card">
	...
	<div class="card-body">
		<form action="{{route('admin.report.selling.sales_due_report')}}" method="post" enctype="multipart/form-data" target="_blank">
			@csrf
			<div class="row">
				...
				<div class="col-md-6 mx-auto">
					<button type="submit" class="btn btn-block btn-info">{{ _lang('Get Sales Due Report') }}</button>
				</div>
			</div>
		</form>
	</div>
