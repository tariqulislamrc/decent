@extends('layouts.app', ['title' => _lang('Employee Advance Payment Report'), 'modal' => 'lg'])
{{-- Header Section --}}
@section('page.header')
<div class="app-title">
	<div>
		<h1 data-placement="bottom" title="Advance Payment Report."><i class="fa fa-universal-access mr-4"></i>
		{{_lang('Employee Advance Payment Report')}}</h1>
	</div>
</div>
@stop
{{-- Main Section --}}
...
<div class="card">
	<div class="card-header">
		<h6>{{_lang('Employee Advance Payment Report')}}</h6>
	</div>
	<div class="card-body">
        <div class="row">
            ...
            <div class="col-md-6 mx-auto">
                <button data-url="{{ route('admin.report.employee-advance-payment-report-ajax')}} " type="button" id="submit" class="btn btn-block btn-info">{{ _lang('Get Sales Report') }}</button>
