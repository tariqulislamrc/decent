    ...
    <div class="table-responsive">
        <table class="table table-hover table-sm table-bordered content_managment_table">
            <thead class="table-info">
                <tr>
                    <th width="15%" class="text-center">Payroll</th>
            ...
            <tbody>
                ...
                @foreach ($models as $model)
                    ...
                    @endphp
                   <tr>
                        <td class="text-center">{{ $model->payroll->salary->payroll_template->name }}</td>
                        @if ($employee == 'All Employee')
