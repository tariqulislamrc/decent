	...
	<div class="card-body">
		<div class="row">
			...
			<div class="col-md-6 mx-auto">
				<button id="submit" data-url="{{route('admin.report.depertment.get_product_report')}}" type="button" class="btn btn-block btn-info">{{ _lang('Report') }}</button>
				<button id="submiting" type="button" style="display: none;" disabled class="btn btn-block btn-info">{{ _lang('Processing') }}</button>
			</div>
		</div>
	</div>
</div>
