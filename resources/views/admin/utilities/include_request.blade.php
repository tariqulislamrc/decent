    ...
    <div class="col-md-5 mx-auto ">
        <div class="card card-box border border-primary">
            <div class="card-body text-center">
                ...
                <p class="card-text font-80pc">{{ _lang('Send Store Request Using Product Or Row Material') }}</p> <a href="{{ $row }}" class="btn btn-primary btn-sm">{{ _lang('Send Store Request') }}</a>
            </div>
        </div>
    </div>
    <div class="col-md-5 mx-auto">
