@extends('layouts.app', ['title' => _lang('Job Cost List'), 'modal' => 'lg'])
@push('admin.css')
<style>
.table th, .table td {
...
<div class="app-title">
    <div>
        <h1 data-placement="bottom" title="Purchases for Production."><i class="fa fa-universal-access mr-4"></i> {{_lang('Job Cost List')}}</h1>
    </div>
</div>
@stop
{{-- Main Section --}}
...
<div class="row">
    <div class="col-md-12">
        <div class="tile">
            ...
            <div class="tile-body">
                <table class="table table-hover table-bordered content_managment_table" data-url="{{ route('admin.paircosting.index') }}">
                    <thead>
                        <tr>
                            <th>{{_lang('Date')}}</th>
                            <th>{{_lang('Ref')}}</th>
                            <th>{{_lang('Product')}}</th>
                            <th>{{_lang('Material Cost')}}</th>
