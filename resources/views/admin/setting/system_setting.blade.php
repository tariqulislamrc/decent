                            ...
                            {{-- This is for Home Section --}}
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="set_mail_driver" class="form-control select" data-placeholder="Select Mail Driver">
                                            <option value="">{{_lang('Select Mail Driver')}}</option>
                                            <option {{get_option('set_mail_driver') == 'sendmail' ? 'selected' : ''}} value="sendmail">{{_lang('SentMail')}}</option>
                                            <option {{get_option('set_mail_driver') == 'mailgun' ? 'selected' : ''}} value="mailgun">{{_lang('Mailgun')}}</option>
                                            <option {{get_option('set_mail_driver') == 'smtp' ? 'selected' : ''}} value="smtp">{{_lang('SMTP')}}</option>
                                            <option {{get_option('set_mail_driver') == 'Log' ? 'selected' : ''}} value="Log">{{_lang('Log')}}</option>
                                        </select>
                                    </div>

                                       <div class="col-md-6">
                                        {{ Form::label('set_sms_gateway', _lang('Set SMS Gateway') , ['class' => 'col-form-label ']) }}
                                        <select name="set_sms_gateway" class="form-control select" data-placeholder="Select SMS Gateway">
                                            <option value="">{{_lang('Select SMS Gateway')}}</option>
                                            <option {{get_option('set_sms_gateway') == 'Nexmo' ? 'selected' : ''}} value="Nexmo">{{_lang('Nexmo')}}</option>
                                            <option {{get_option('set_sms_gateway') == 'Twillo' ? 'selected' : ''}} value="Twillo">{{_lang('Twillo')}}</option>
                                            <option {{get_option('set_sms_gateway') == 'Custom' ? 'selected' : ''}} value="Custom">{{_lang('Custom')}}</option>
                                        </select>
                                    </div>
