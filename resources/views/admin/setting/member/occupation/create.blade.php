<div class="card">
    <div class="card-header">
        <h6>{{_lang('Create New Occupation')}}</h6>
    </div>
    <div class="card-body">
        <form action="{{route('admin.setting.member-setting.occupation.store')}}" method="POST" id="content_form">
            <div class="row">    
                {{-- Occupation Name --}}
                <div class="col-md-12 form-group">
                    <label for="name">{{_lang('Occupation Name')}} <span class="text-danger">*</span> </label>
                    <input type="text" name="name" id="name" class="form-control" required placeholder="Enter Occupation Name">
                </div>
                ...
                <div class="col-md-12 form-group">
                    ...
                    <textarea name="description" id="description" class="form-control" placeholder="Enter Occupation Description" cols="30" rows="2"></textarea>
                </div>
            </div>
