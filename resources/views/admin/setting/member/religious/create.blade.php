<div class="card">
    <div class="card-header">
        <h6>{{_lang('Create New Religious')}}</h6>
    </div>
    <div class="card-body">
        <form action="{{route('admin.setting.member-setting.religious.store')}}" method="POST" id="content_form">
            <div class="row">    
                {{-- Religious Name --}}
                <div class="col-md-12 form-group">
                    <label for="name">{{_lang('Religious Name')}} <span class="text-danger">*</span> </label>
                    <input type="text" name="name" id="name" class="form-control" required placeholder="Enter Religious Name">
                </div>
