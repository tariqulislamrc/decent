@extends('layouts.report', ['title' => _lang('Material Report'),'report_title'=>_lang('Total Material Report in Store Request')])
@section('content')
<div class="container-fluid px-4 pt-4">
    <div class="row">
        <div class="col-md-6">
            <p class="h5 text-uppercase"><b>{{ _lang('Total Material Report in Store Request') }}: 
            <p><b>{{ _lang('Total Material Report in Store Request') }}: </b> {{ date('Y-m-d') }} </p>
        </div>
